...
describe UsersController do
  ...
  describe "GET 'index'"do
	...
	describe "for signed-in-users" do
	  ...
	  before(:each) do
		...
		# did not write up Factory spec file L10, 1:35
		30.times do
	  ...
	  it "should have the right title" do
		get :index
		response.should have selector('title', :content => "All Users")
	  end
	  ...
	  it "shold have a delete links for admin" do
		@user.toggle!(:admin)
	  ...
	  it "shold not have a delete links for non-admin" do
		#@user.toggle!(:admin)
		other_user = User.all.second
		get :index
  ...
  describe "GET 'show'" do
	...
	it "should have the right URL" do
	  get :show, :id => @user
	  response.should have_selector('tb>a', :constent => user_path(@user),
											:href => user_path(@user))
	end
  ...
  describe "PUT 'update'" do
	...
	describe "failure" do
	  ...
	  it "should render the 'edit' page" do
	    ...
	    resposne.should render_template('edit')
	  end
